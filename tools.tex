...
\textcite{Prather2017CEM} note that the difficulty in understanding them
\textcquote{Prather2017CEM}{can be a major impediment to novice student
learning}, and a sizeable body of work has tried to rewrite them into something
novices can act on. Their own human-factors study is two-sided about that
remedy: \textcquote{Prather2017CEM}{[q]uantitative results from a 60 minute
one-on-one think-aloud study with 31 students did not show substantial
increase in student learning outcomes over the control}, while the
qualitative results indicated that
\textcquote{Prather2017CEM}{most students are reading enhanced compiler error
messages and generally make effective changes after encountering them}. So
better messages are read and acted on; that they raise learning outcomes is
not shown.
...
target.
That is also why this section contributes context rather than catalogue
entries: what the literature documents about tools are \emph{difficulties} ---
messages that are hard to read --- rather than false beliefs about the
language that a pattern of variation could contrast away.
