...
if one had only ever practised at a single distance \parencite[pp.~72--73]{NCOL}.
...
values of a single dimension, and dealing with all of them at once produced far
greater gains (63\%) than treating them separately (15\%), a difference that
persisted on a delayed test \parencite[pp.~167--168]{NCOL}.
