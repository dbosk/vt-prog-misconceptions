...
\Textcite[p.~24]{NCOL} reports on a study by \textcite{Neuman1987} in which a
six-year-old child answers \enquote{five} when asked how many fingers she has on
her left hand, but \enquote{ten} when asked about her right hand. The child is
...
On Neuman's analysis, numbers have three properties that arithmetic requires:
they are \emph{ordinal} (first, second, third, \dots), they are \emph{cardinal}
(one, two, three, \dots), and they stand in \emph{part--whole} relations
