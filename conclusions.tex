...
a natural design is to teach with them and measure the effect with a
concept inventory before and after. The literature coverage has recorded
limits: citation snowballing was deferred, one major index was unavailable
during the systematic search (\cref{app:litlimitations}), and several papers
kept by the screening remain to be integrated into the catalogue. Some
...
\begin{frame}
  \begin{block}{Conclusions}
    \begin{itemize}
      ...
      \item Next: integrate remaining papers; evaluate in the classroom.
    \end{itemize}
  \end{block}
\end{frame}%
}
