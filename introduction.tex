...
assignments or labs.
Personal teaching experience is, however, an unreliable guide to which
misconceptions are most common: \textcite{Brown2014} found that educators reach
only a weak consensus about the most frequent novice mistakes, that their
rankings match large-scale student data only moderately, and that more teaching
experience did not improve this agreement.
This is part of why we ground our catalogue in the literature rather than in our
own impressions.
Misconceptions occur when a student has discerned some aspects of a phenomenon,
but not others \autocite{NCOL}.
