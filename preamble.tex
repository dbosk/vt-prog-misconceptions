...
% The verbose margin citations are deferred like floats; a citation-dense
% chapter (e.g. related work) otherwise exhausts the default float registers
% with "! LaTeX Error: Too many unprocessed floats."
\extrafloats{100}
