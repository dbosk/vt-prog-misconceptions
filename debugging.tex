...
that surfaces as delayed, or \emph{generative}, learning, where outcomes improve
some time after instruction with patterns, with no such effect for students
taught without them \parencite[pp.~227--228]{NCOL}. In the context of
