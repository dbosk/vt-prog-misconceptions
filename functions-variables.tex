...
\begin{description}
  ...
  \item[Fusion] Finally we fuse the directional reading with the flow of values
    over time: tracing several reassignments, the student must see each
    \mintinline{python}{=} act on the value left by the previous line.
