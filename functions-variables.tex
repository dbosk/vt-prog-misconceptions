...
and then never call it, expecting the definition alone to run its body.
...
\begin{description}
  ...
  \item[Generalisation] Holding the rule invariant --- the right-hand side is
    ...
    including the augmented form \mintinline{python}{x += 1} that
    \textcite{Kohn2017VariableEvaluation} found easier for novices, since it does
    not repeat the name and so does not invite the equation reading.
